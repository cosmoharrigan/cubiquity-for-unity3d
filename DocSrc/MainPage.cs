 ...
 *
 * \subpage pageInstallation "Installation"
 * \par
 * You can obtain %Cubiquity for Unity3D from the asset store or from our Git repository. Or perhaps you have it already and are reading a local copy of this documentation. In any case you will want to add it to your project and this section explains how. \ref pageInstallation "Read more..."
 *
 * \subpage pageQuickStart "Quick Start"
 * \par
 * We can't blame you for wanting to get started quickly, and often the best way to learn is by experimentation. This section will just give you the basic knowledge you need to create your first voxel environments. You can then read other sections of this manual when you want more details of a specific topic. \ref pageQuickStart "Read more..."
 *
 * \subpage pagePrinciples "Main Principles"
 * \par
 * To make the most of %Cubiquity for Unity3D you will want an understanding of the different components of the system and how they fit together. This section provides a discussion of the key concepts behind %Cubiquity for Unity3D and presents the different classes you will be working with. A good understanding of this section will be important to make effective use of our system, particularly if you want to make a lot of use of it from code. \ref pagePrinciples "Read more..."
 *
 * \subpage pageUserInterface "Using the Visual Interface"
 * \par
